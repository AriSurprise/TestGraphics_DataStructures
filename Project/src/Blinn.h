...
namespace dp //! Contents for use within class assignments
{
  ...
  class Blinn : public Material //! Lightweight realistic lighting shading type
  {
  public:
    ...
    \brief
      - create a diffuse shaded material using the given attribute settings
    \param blinn
      - linked, blinn shader program to have material attributes fed into
    \param diffuseColor
    ...
    */
    Blinn(Shader& blinn, const v3f& diffuseColor = WHITE,
    ...
    /** Create a Blinn material using source's attribute settings
    \brief
      - create a Blinn material using source's attribute settings
    \param source
      - material to use for copying attribute settings
    */
    Blinn(const Blinn& source);
    ...
    */
    ...
    \param ambientColor
      - float [0,1] RGB value being used for this material ambient shading
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& Ambient(const v3f& ambientColor);
    ...
    */
    ...
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& Diffuse(const v3f& diffuseColor);
    ...
    */
    ...
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& Fresnel(const v3f& fresnelColor);
    ...
    */
    ...
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& Incandescence(const v3f& incandescentColor);
    ...
    */
    ...
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& Specular(const v3f& specularColor);
    ...
    */
    ...
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& StationPoint(const v3f& cameraPosition);
    ...
    \brief
      - copy a source Blinn's material attribute settings into this Blinn
    \param source
      - Blinn material to have current attribute settings copied
    \return
      - reference to the modified Blinn for easier subsequent inline action
    */
    Blinn& operator=(const Blinn& source);
